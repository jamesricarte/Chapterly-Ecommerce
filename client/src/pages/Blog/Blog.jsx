      ...
      <section className="container mx-auto flex justify-center pt-10">
        ...
        >
          <div className="flex items-center">
            <div className="w-2/3">
              <h1 className="text-4xl pl-12 pt-8 pb-8 font-semibold tracking-tight text-white">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {[...Array(3)].map((_, index) => (
              <div
                key={index}
                className="bg-secondary-500 border shadow-md h-[30rem]"
              >
                <img
                  src={blogThumbnail1}
                  alt={`Blog ${index + 1}`}
                ...
                <div className="p-4 h-2/5">
                  ...
                  <p className="mt-2 text-sm text-white">Explain</p>
                </div>
              </div>
            ))}
            {[...Array(3)].map((_, index) => (
